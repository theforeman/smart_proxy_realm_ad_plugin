...
build-gem: ## Build local gem and install into smart-proxy plugins
	docker exec -it $(CONTAINER_NAME) /bin/bash -c "cd /app && gem build smart_proxy_realm_ad_plugin.gemspec"
